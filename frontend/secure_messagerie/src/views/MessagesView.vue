...
const composerBlockedInfo = computed(() => {
  ...
  if (conv.blockedByOther) {
    return {
      ...
      title: 'Conversation bloqu̩e',
      message:
        `${conv.displayName || 'Ce contact'} a bloqu̩ cette conversation. Vous ne pouvez plus r̩pondre tant que le contact ne vous a pas d̩bloqu̩.`,
    }
  }
  if (conv.blockedByMe) {
    return {
